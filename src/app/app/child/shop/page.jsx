...
export default function Shop() {
    ...
    //             const myPetItemsResult = await graphqlDebugRequest(
    //                 "MY_PET_ITEMS_QUERY",
    //                 MY_PET_ITEMS_QUERY
    //             )

    //             if (achievementsResult.errors?.length) {
    //                 setErr("Ошибка в запросе MY_ACHIEVEMENTS_QUERY")
    //                 return
    //             }

    //             if (categoriesResult.errors?.length) {
    //                 setErr("Ошибка в запросе PET_ITEM_CATEGORIES_QUERY")
    //                 return
    //             }

    //             if (catalogResult.errors?.length) {
    //                 setErr("Ошибка в запросе PET_CATALOG_QUERY")
    //                 return
    //             }

    //             if (myPetItemsResult.errors?.length) {
    //                 setErr("Ошибка в запросе MY_PET_ITEMS_QUERY")
    //                 return
    //             }

    //             const preparedData = {
    //                 myAchievements: achievementsResult.data?.myAchievements || [],
    //                 petItemCategories: categoriesResult.data?.petItemCategories || [],
    //                 petCatalog: catalogResult.data?.petCatalog || { data: [] },
    //                 myPetItems: myPetItemsResult.data?.myPetItems || []
    //             }

    //             setAchievementsList(prepareAchievements(preparedData))
    //             setItemsList(preparePetRoomItems(preparedData))
