...
import MenuChellengeAnalytics from "../another/analytics/chellenge/menu/Menu"
import DropDown from "../another/analytics/chellenge/dropdown/DropDown"
import Result from "../another/analytics/chellenge/showResult/Result"

const CHALLENGE_ANALYTICS_QUERY = `
    query ChallengeAnalytics($child_id: String, $category: String, $months: Int!) {
        challengeAnalytics(child_id: $child_id, category: $category, months: $months) {
            month
            selected_count
            completed_count
            failed_count
